...
// --- CAMBIO 1: El icono ya no decide su propio color. Lo heredará del CSS. ---
const HeartIconPlayerBar = () => (
  ...
  return (
    <div className="player-bar">
      <div className="player-song-info-wrapper">
        ...
        {/* --- CAMBIO 2: Se simplifica la llamada a onToggleLike y al icono HeartIconPlayerBar --- */}
        {onToggleLike && ( 
            <button onClick={() => onToggleLike(song.id)} className={`control-button like-button-player-bar ${song.userHasLiked ? 'liked' : ''}`} title={song.userHasLiked ? "Quitar Me gusta" : "Me gusta"}>
                <HeartIconPlayerBar />
            </button>
        )}
      </div>
